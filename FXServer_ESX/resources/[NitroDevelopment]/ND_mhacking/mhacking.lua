...
AddEventHandler('ND_mhacking:show', function()
    nuiMsg = {}
	nuiMsg.show = true
	SendNUIMessage(nuiMsg)
...
AddEventHandler('ND_mhacking:hide', function()
    nuiMsg = {}
	nuiMsg.show = false
	SendNUIMessage(nuiMsg)
...
AddEventHandler('ND_mhacking:start', function(solutionlength, duration, callback)
    ND_mhackingCallback = callback
	nuiMsg = {}
...
AddEventHandler('ND_mhacking:setmessage', function(msg)
    nuiMsg = {}
...
RegisterNUICallback('callback', function(data, cb)
	ND_mhackingCallback(data.success, data.remainingtime)
    cb('ok')
end)
