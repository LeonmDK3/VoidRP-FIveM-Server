RegisterNetEvent('ND_notify:client:SendAlert')
AddEventHandler('ND_notify:client:SendAlert', function(data)
	DoCustomHudText(data.type, data.text, data.length, data.style)
end)

RegisterNetEvent('ND_notify:client:PersistentHudText')
AddEventHandler('ND_notify:client:PersistentHudText', function(data)
