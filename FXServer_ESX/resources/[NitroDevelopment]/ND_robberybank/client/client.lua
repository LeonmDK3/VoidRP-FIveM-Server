...
AddEventHandler('esx_holdupbank:currentlyhacking', function(robb, thisbank)
	...
	TriggerEvent("ND_mhacking:start",7,150, opendoors)
	savedbank = thisbank
	bank = robb
	secondsRemaining = 300
end)
...
function opendoors(success, timeremaining)
	if success then
		...
		hackholdingup = false
		exports['ND_notify']:DoHudText('error', 'Hack Failed')
		print('Failure')
		TriggerEvent('ND_mhacking:hide')
		secondsRemaining = 0
		incircle = false
...
AddEventHandler('esx_holdupbank:toofarlocal', function(robb)
	holdingup = false
	bombholdingup = false
	exports['ND_notify']:DoHudText('inform', 'Robbery Cancelled!')
	robbingName = ""
	secondsRemaining = 0
	incircle = false
end)
...
AddEventHandler('esx_holdupbank:toofarlocalhack', function(robb)
	holdingup = false
	exports['ND_notify']:DoHudText('error', 'Robbery Failed!')
	robbingName = ""
	secondsRemaining = 0
	incircle = false
end)
...
AddEventHandler('esx_holdupbank:robberycomplete', function(robb)
	holdingup = false
	exports['ND_notify']:DoHudText('success', 'Robbery Complete!') .. Banks[bank].reward)
	bank = ""
...
AddEventHandler('esx_holdupbank:hackcomplete', function()
	hackholdingup = false
	exports['ND_notify']:DoHudText('success', 'Hack Complete!')
...
AddEventHandler('esx_holdupbank:plantbombcomplete', function(bank)
	...
	exports['ND_notify']:DoHudText('inform', 'Bomb Planted!')
...
AddEventHandler('esx_holdupbank:opendoors', function(x,y,z,doortype)
	...
	exports['ND_notify']:DoHudText('inform', ("X: "..x))
