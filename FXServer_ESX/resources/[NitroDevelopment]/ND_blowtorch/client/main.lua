...
RegisterNetEvent('ND_blowtorch:startblowtorch')
AddEventHandler('ND_blowtorch:startblowtorch', function(source)
	blowtorchAnimation()
	Citizen.CreateThread(function()
		while true do
...
RegisterNetEvent('ND_blowtorch:finishclear')
AddEventHandler('ND_blowtorch:finishclear', function(source)
	clearweld = false
end)


RegisterNetEvent('ND_blowtorch:clearweld')
AddEventHandler('ND_blowtorch:clearweld', function(x,y,z)
		clearweld = true
		Citizen.CreateThread(function()
			while clearweld do
				Wait(1000)
...
RegisterNetEvent('ND_blowtorch:stopblowtorching')
AddEventHandler('ND_blowtorch:stopblowtorching', function()
	blowtorching = false
	blowtorchingtime = 0
	ClearPedTasksImmediately(GetPlayerPed(-1))
end)

--RegisterNetEvent('ND_blowtorch:opendoors')
--AddEventHandler('ND_blowtorch:opendoors', function(x,y,z)
	--Citizen.CreateThread(function()
	--while dooropen do
		--Wait(5000)
...
function blowtorchAnimation()
	...
	TriggerServerEvent('ND_holdupbank:clearweld', {coords.x, coords.y, coords.z})
	Citizen.CreateThread(function()
			blowtorching = true
			Citizen.CreateThread(function()
