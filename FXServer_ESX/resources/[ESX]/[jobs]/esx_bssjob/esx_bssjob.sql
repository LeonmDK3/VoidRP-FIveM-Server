...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('bss',0,'recruit','Recruit',20,'{}','{}'),
	('bss',1,'officer','Security Guard',40,'{}','{}'),
	('bss',2,'sergeant','Supervisor',60,'{}','{}'),
	('bss',3,'lieutenant','Assistant Manager',100,'{}','{}'),
	('bss',4,'boss','Manager',100,'{}','{}'),
	('bss',5,'boss','Owner',100,'{}','{}'),
;

CREATE TABLE `bss_fine_types` (
...
INSERT INTO `bss_fine_types` (label, amount, category) VALUES
