...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			local shopElements = {}
			local shopCoords = Config.bssStations[station][part][partNum].InsideShop
							...
							if data2.current.stored then
								...
								if foundSpawn then
									...
									ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
										...
										exports['ND_notify']:DoHudText('success', 'Your Vehicle Has Been Released From The Garage!')
									end)
								end
							else
								exports['ND_notify']:DoHudText('inform', 'Your Garage Is Not Available!')
							end
						end, function(data2, menu2)
							menu2.close()
						end)
					else
						exports['ND_notify']:DoHudText('inform', 'Your Garage Is Empty!')
					end
				else
					exports['ND_notify']:DoHudText('inform', 'Your Garage Is Empty!')
				end
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('esx_bssjob:storeNearbyVehicle', function(storeSuccess, foundNum)
		if storeSuccess then
			...
			IsBusy = false
			exports['ND_notify']:DoHudText('success', 'Your Vehicle Has Been Stored Into The Garage!')
		else
			exports['ND_notify']:DoHudText('error', 'Your Vehicle Has Not Been Stored Into The Garage!')
		end
	end, vehiclePlates)
end

function GetAvailableVehicleSpawnPoint(station, part, partNum)
	local spawnPoints = Config.bssStations[station][part][partNum].SpawnPoints
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_bssjob:buyJobVehicle', function (bought)
					if bought then
						exports['ND_notify']:DoHudText('success', 'You Have Bought A New Vehicle!')
