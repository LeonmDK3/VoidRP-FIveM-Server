...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('lspd',0,'recruit','Cadet',20,'{}','{}'),
	('lspd',1,'officer','Officer',40,'{}','{}'),
	('lspd',2,'officer','Senior Officer',60,'{}','{}'),
	('lspd',3,'officer','Corporal',100,'{}','{}'),
	('lspd',4,'sergeant','Sergeant',100,'{}','{}'),
	('lspd',5,'sergeant','Lieutenant',100,'{}','{}'),
	('lspd',6,'sergeant','Captain',100,'{}','{}'),
	('lspd',7,'boss','Major',100,'{}','{}'),
	('lspd',8,'boss','Assistant Chief',100,'{}','{}'),
	('lspd',9,'boss','Deputy Chief',100,'{}','{}'),
	('lspd',10,'boss','Chief Of Police',100,'{}','{}')
;

CREATE TABLE `lspd_fine_types` (
...
INSERT INTO `lspd_fine_types` (label, amount, category) VALUES
