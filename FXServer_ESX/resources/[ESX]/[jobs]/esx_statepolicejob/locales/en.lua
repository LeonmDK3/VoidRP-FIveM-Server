Locales['en'] = {
  ...
  ['statepolice_wear'] = 'statepolice Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~statepolice~s~',
  -- Vehicle interaction
