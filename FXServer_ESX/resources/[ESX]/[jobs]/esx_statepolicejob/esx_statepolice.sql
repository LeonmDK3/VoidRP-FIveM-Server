...
INSERT INTO `addon_account` (name, label, shared) VALUES
	('society_statepolice', 'statepolice', 1)
;
...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('sahp',0,'recruit','Probationary Trooper',20,'{}','{}'),
	('sahp',1,'officer','Trooper',40,'{}','{}'),
	('sahp',2,'officer','Trooper First Class',60,'{}','{}'),
	('sahp',3,'officer','Corporal',100,'{}','{}'),
	('sahp',4,'sergeant','Sergeant',100,'{}','{}'),
	('sahp',5,'sergeant','Lieutenant',100,'{}','{}'),
	('sahp',6,'sergeant','Captain',100,'{}','{}'),
	('sahp',7,'boss','Major',100,'{}','{}'),
	('sahp',8,'boss','Lieutenant Colonel',100,'{}','{}'),
	('sahp',9,'boss','Colonel',100,'{}','{}')
;

CREATE TABLE `sahp_fine_types` (
...
INSERT INTO `sahp_fine_types` (label, amount, category) VALUES
