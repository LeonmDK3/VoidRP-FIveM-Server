...
Config.AuthorizedVehicles = {
	car = {
		ambulance = {
			...
			{model = 'usa', price = 100},
			{model = 'usa2', price = 100},
			{model = 'usa3', price = 100},
			{model = 'usa4', price = 100},
			{model = 'usa5', price = 100},
			{model = 'usa6', price = 100},
			{model = 'usa7', price = 100},
			{model = 'usa8', price = 100},
			{model = 'usa9', price = 100},
			{model = 'trailerfire', price = 100},
			{model = 'trailerhazmat', price = 100},
			{model = 'trailerswat', price = 100},
		},
