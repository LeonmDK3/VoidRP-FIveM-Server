...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('bcso',0,'recruit','Probationary Deputy',20,'{}','{}'),
	('bcso',1,'officer','Deputy',40,'{}','{}'),
	('bcso',2,'officer','Master Deputy',60,'{}','{}'),
	('bcso',3,'officer','Corporal',100,'{}','{}'),
	('bcso',4,'sergeant','Sergeant',100,'{}','{}'),
	('bcso',5,'sergeant','Lieutenant',100,'{}','{}'),
	('bcso',6,'sergeant','Captain',100,'{}','{}'),
	('bcso',7,'boss','Major',100,'{}','{}'),
	('bcso',8,'boss','Undersheriff',100,'{}','{}'),
	('bcso',9,'boss','Sheriff',100,'{}','{}')
;

CREATE TABLE `bsco_fine_types` (
...
INSERT INTO `bsco_fine_types` (label, amount, category) VALUES
