...
AddEventHandler('esx_holdup:tooFar', function()
	...
	exports['mythic_notify']:DoHudText('error', 'Robbery Cancelled', { ['background-color'] = '#ffffff', ['color'] = '#000000' })
end)
...
AddEventHandler('esx_holdup:robberyComplete', function(award)
	...
	exports['mythic_notify']:DoHudText('success', 'Robbery Complete', award { ['background-color'] = '#ffffff', ['color'] = '#000000' })
end)
			...
			if distance < Config.Marker.DrawDistance then
				if not holdingUp then
					...
					if distance < 0.5 then
						...
						exports['mythic_notify']:DoHudText('inform', 'Press To Rob', { ['background-color'] = '#ffffff', ['color'] = '#000000' })
						...
						if IsControlJustReleased(0, Keys['E']) then
							if IsPedArmed(PlayerPedId(), 4) then
								...
								exports['mythic_notify']:DoHudText('error', 'No Threat', { ['background-color'] = '#ffffff', ['color'] = '#000000' })
							end
						end
					end
				end
