...
AddEventHandler('iens:repair', function()
	if isPedDrivingAVehicle() then
      ...
      exports['ND_notify']:DoHudText('inform', '~g~The Mechanic Repaired Your Car!')
			return
		end
        ...
        exports['ND_notify']:DoHudText('inform', 'You Need to get to a Mechanic!')
        ...
        exports['ND_notify']:DoHudText('inform', '~r~Your Vehicle Is Too Badly Damaged. Unable to repair!')
			end
		else
			notification("~y~" .. repairCfg.noFixMessages[noFixMessagePos] )
      exports['ND_notify']:DoHudText('inform', '"~y~" .. repairCfg.noFixMessages[noFixMessagePos] ')
      ...
      exports['ND_notify']:DoHudText('error', '~r~You Must Be In A Vehicle To Be Able To Repair It!')
	end
end)
...
AddEventHandler('iens:notAllowed', function()
  ...
  exports['ND_notify']:DoHudText('error', '~r~You Don't Have Permission To Repair Vehicles')
end)
