TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannelWait = "TokoVOIP Server Waiting Room IPS DESC", "[Lobby]",

		-- Blocking screen informations
		TSServer = "coreserverau.com", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "Waiting For Staff", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "http://www.voidroleplay.com", -- Download link displayed on blocking screen
